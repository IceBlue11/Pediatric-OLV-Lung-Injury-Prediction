...
def make_paper_pack(run_id: str):
    ...
    files_to_copy = {
        ...
        extra_dir / "calibration.svg": pack_dir / "calibration.svg",
        extra_dir / "dca.svg": pack_dir / "dca.svg",
        extra_dir / "forest_or.svg": pack_dir / "forest_or.svg",
    ...
    lines.append("- DCA plot includes model, treat-all, and treat-none curves; interpret net benefit visually from the plot.")
    lines.append(f"Source: {extra_dir.as_posix()}/dca.svg")
    lines.append("")
